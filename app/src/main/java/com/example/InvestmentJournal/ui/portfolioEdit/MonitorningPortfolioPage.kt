...
import com.example.InvestmentJournal.ui.portfolioEdit.AddPortfolioDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

@Composable
fun PortfolioEditPage(viewModel: PortfolioViewModel, navHostController: NavHostController) {
        ...
        if (showDialog) {
            AddPortfolioDialog(
                ...
                onCreate = { portfolioName ->
                    viewModel.createPortfolio(portfolioName)
                    showDialog = false
                }
            )
        }
